...
public class HttpClientUtil {
    ...
    static {
        ...
        // 设置读取超时
        configBuilder.setSocketTimeout(5*MAX_TIMEOUT);
        // 设置从连接池获取连接实例的超时
...
//            httpPost.setEntity(new UrlEncodedFormEntity(pairList, Charset.forName("UTF-8")));
//            BasicClientCookie cookie = new BasicClientCookie("ASP.NET_SessionId", "cmffblu50hsiouffosezs555");
//            cookie.setVersion(0);
//            cookie.setDomain("/pms/");   //设置范围
//            cookie.setPath("/");
//            cookieStore.addCookie(cookie);
//            BasicClientCookie cookie1 = new BasicClientCookie(".LOGIN_AUTH", "kd+nchyPyYdU2wpCgvdcNZxs0pr0+MMowwWDkUhggVbYcULWZnWGfWo1QRfHzY/4gpmeBLTHAgE=");
